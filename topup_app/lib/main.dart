...
void main() => runApp(const QtagTopupApp());
...
class QtagTopupApp extends StatelessWidget {
  const QtagTopupApp({super.key});
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<bool>(
      ...
      builder: (context, snap) {
        ...
        return snap.data == true ? const TopupScreen() : const LoginScreen();
      },
    );
  }
}
