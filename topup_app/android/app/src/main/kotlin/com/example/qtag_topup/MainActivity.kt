package com.example.qtag_topup
...
/**
 * Flutter ↔ Hopeland UHF SDK bridge (HY820) for the QTag Topup app.
 * Same flow as the scanner app: OpenConnect → GetEPC_TID → OutPutEPC callback.
 */
                    ...
                    "connect" -> io.execute {
                        val ok = try {
                            ...
                            if (r) {
                                ...
                                // Perf: throttle duplicate tag uploads (same tag re-reports
                                // at most ~every 500ms; new tags still report immediately).
