...
class Frame_0010_14(BaseFrame):
    def __init__(self, *data):
        try:
            ...
            raise RuntimeError("Frame_0010_14(),Error!" + str(e))

    DIC_RESPONSE_CODE = {0: "0|Success",
                         1: "1|Antenna port parameter error",
                         2: "2|Wrong parameter selection",
                         3: "3|QT Wrong parameter",
                         4: "4|CRC check error",
                         5: "5|Power shortage",
                         6: "6|Password error",
                         7: "7|Other label errors",
                         8: "8|Label loss",
                         9: "9|Reader failed to send instructions"
                         }
