...
from .booth_console import (
    ...
    BoothCameraStreamStopView,
    BoothCameraStreamView,
    BoothCameraView,
...
urlpatterns = [
    ...
    path('api/camera/stream/', BoothCameraStreamView.as_view(),
         name='booth-camera-stream'),
    path('api/camera/stream/stop/', BoothCameraStreamStopView.as_view(),
         name='booth-camera-stream-stop'),
